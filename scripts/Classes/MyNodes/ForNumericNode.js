...
class ForNumericNode extends MyNode {
    ...
    createBlock() {
        ...
        let handler = this.distributor.getNodeObject(this.node.child(3), null);
        ...
        handler = this.distributor.getNodeObject(this.node.child(5), null);
        ...
        if (this.node.child(6).type === ',') {
            ...
            handler = this.distributor.getNodeObject(this.node.child(7), null);
        ...
        createBlocklyCode(includedComments, this.distributor, "DO", tempBlock);
        return tempBlock;
    }
