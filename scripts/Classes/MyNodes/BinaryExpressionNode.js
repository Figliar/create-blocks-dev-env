...
class BinaryExpressionNode extends MyNode {
    ...
    createBlock() {
        ...
        let leftNodeHandler = this.distributor.getNodeObject(this.node.firstChild, null);
        let rightNodeHandler = this.distributor.getNodeObject(this.node.lastChild, null);
    ...
    _createConcatenationBlock() {
        ...
        for (let i= 0; i < children.length; i++){
            ...
            strNodeHandler = this.distributor.getNodeObject(children[i], null);
