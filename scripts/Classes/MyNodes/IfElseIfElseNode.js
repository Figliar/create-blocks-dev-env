...
class IfElseIfElseNode extends MyNode {
    ...
    createBlock() {
        ...
        let conditionNodeHandler = this.distributor.getNodeObject(this.node.child(1), null);
        ...
        if(ifNode !== null) {
            ...
            createBlocklyCode(ifNode, this.distributor, "DO0", ifBlock);
            ...
            while (next) {
                if(next.type) {
                    if (next.type === 'elseif_clause') {
                        ...
                        conditionNodeHandler = this.distributor.getNodeObject(next.child(1), null);
                        ...
                        createBlocklyCode(includedComments, this.distributor, `DO${count}`, ifBlock);
                        count = count + 1;
                    }
                        ...
                        createBlocklyCode(includedComments, this.distributor, "ELSE", ifBlock);
                    }
                }
