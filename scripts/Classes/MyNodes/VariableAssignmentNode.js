...
class VariableAssignmentNode extends MyNode {
    ...
    createBlock() {
        ...
        const rightSideNodeHandler = this.distributor.getNodeObject(this.node.lastChild.firstChild, null);
     ...
     */
     _createLeftSide(){
        ...
        if (leftVariable.childCount === 1) {
            ...
            let indexHandler = this.distributor.getNodeObject(leftVariable.child(2), null);
